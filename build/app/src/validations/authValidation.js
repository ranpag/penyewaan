...
const uniqueUsername = async (value, _helper) => {
    const admin_username = await prisma.admin.findUnique({
        where: { admin_username: value }
    });
    if (admin_username) {
        throw new Joi.ValidationError("Admin username sudah ada", [
            {
...
const signup = {
    body: Joi.object()
        ...
        admin_password: Joi.string()
            ...
            "string.pattern.base": "Password admin harus mengandung minimal satu huruf besar, satu huruf kecil, satu angka, dan satu karakter spesial (@$!%*?&)"
        }),
...
const changePassword = {
    body: Joi.object()
        ...
        new_password: Joi.string()
            ...
            "string.pattern.base": "Password baru harus mengandung minimal satu huruf besar, satu huruf kecil, satu angka, dan satu karakter spesial (@$!%*?&)"
        }),
        confirm_password: Joi.string()
            .trim()
            .required()
